    ...
    //Select the school teachers
    $sql = "SELECT * FROM class_subjects WHERE teacher_id = ?  LIMIT 4";
    $stmt = $con->prepare($sql);
    $stmt->bindParam(1, $_SESSION['id']);
    $stmt->execute();
                ...
                <div class="flex justify-between flex-col h-full border-r border-gray-300">
                    ...
                    <div class="flex mt-2">
                        <ul class=" w-full">
                            ...
                            <li style="font-family: 'Inter', sans-serif;" class="flex flex-row items-center bg-blue-100 pl-16 py-2 font-regular text-md flex justify-between items-center cursor-pointer text-blue-600">
                                <div>
                            ...
                            <li onclick="window.location.href='teacherClass.php'" style="font-family: 'Inter', sans-serif;" class="flex flex-row items-center font-regular pl-16 py-2 my-3 text-md cursor-pointer hover:text-blue-600 transition-colors duration-300">
            ...
            <div class="flex w-5/6 h-screen flex-col">
                ...
                <div class="flex flex-row w-full h-200 overflow-scroll overflow-x-hidden">
                    <div class="flex flex-col w-3/4 bg-slate-50">
                        ...
                        <!--Show classes list-->
                        <div class="w-fill h-40 mx-10 mb-20 rounded-md bg-white shadow-md flex flex-col">
                            <div class="border-b-2 w-full h-14 flex pl-5 items-center">
                                <p class="font-medium text-lg">Recent Classes</p>
                            </div>
                            ...
                            <div class="h-80 overflow-y-auto text-black h-fill">
                                <?php if ($dataClasses) : ?>
                                    <ul class="divide-y divide-gray-200 h-full flex flex-row">
                                        <?php foreach (array_slice($dataClasses, 0, 4) as $class) : ?>
