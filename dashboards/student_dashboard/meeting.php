            ...
            <div class="flex justify-between flex-col h-full border-r border-gray-300">
                ...
                <div class="flex mt-2">
                    <ul class=" w-full">
                        ...
                        <li onclick="window.location.href='studentDashboard.php'" style="font-family: 'Inter', sans-serif;" class="flex flex-row items-center font-regular pl-16 py-2 my-2 text-md cursor-pointer hover:text-blue-600 transition-colors duration-300">
