            ...
            <div class="flex justify-between flex-col h-full border-r border-gray-300">
                ...
                <div class="flex mt-2">
                    <ul class=" w-full">
                        ...
                        <li onclick="window.location.href='studentDashboard.php'" style="font-family: 'Inter', sans-serif;" class="flex flex-row items-center bg-blue-100 pl-16 py-2 font-regular text-md flex justify-between items-center cursor-pointer text-blue-600">
                            <div>
        ...
        <div class="flex w-5/6 h-screen flex-col">
            ...
            <div class="flex flex-row w-full h-screen overflow-scroll overflow-x-hidden">
                <div class="flex flex-col w-3/4 bg-slate-50">
                    ...
                    <div class="w-fill h-48 mx-10 my-10 rounded-md bg-blue-950 text-white shadow-md p-7 flex flex-row">
                        <div class="flex flex-col w-3/6 h-full justify-between">
                            <div>
                                <p class="text-xl font-medium">Navigate to your class</p>
                                <p class="text-sm font-light mt-2"> Access your class and stay on top of assignments, materials, and important information. With our platform, managing your studying is a breeze.</p>
                            </div>
                            <div>
                                <button onclick="window.location.href='class.php'" class="text-white font-medium rounded-md py-1 px-4 bg-blue-900 transition duration-300 ease-in-out">Explore Class ➜</button>
                            </div>
                        </div>
                    ...
                    <div class="w-fill h-28 m-10 rounded-md flex flex-row justify-between">
                        <div class="flex items-center shadow-md w-5/12 h-28">
                            <div class="flex flex-row items-center">
                                ...
                                <div class="flex flex-col">
                                    <p class="text-md font-light">Your Class:</p>
                                    <p class="text-md font-medium"><?= empty($className['class_name']) ? 'Join a class first!' : $className['class_name'] ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center shadow-md w-5/12 h-28">
                            <div class="flex flex-row items-center">
                                ...
                                <div class="flex flex-col">
                                    <p class="text-md font-light">Total Number of Subjects:</p>
                                    <p class="text-md font-medium"><?= empty($numSubjects) ? 'Join a class first!' : $numSubjects ?></p>
                                </div>
                            </div>
                        </div>
                    ...
                    <!--Show classes list-->
                    <div class="w-fill h-40 mx-10 mb-14 rounded-md bg-white shadow-md flex flex-col">
                        <div class="border-b-2 w-full h-14 flex pl-5 items-center">
                            <p class="font-medium text-lg">Subjects Overview</p>
                        </div>
                                    ...
                                    <?php foreach ($dataSubjects as $subject) : ?>
                                        ...
                                        <li class="py-4 flex w-1/4 border-2 rounded-md h-fill items-center">
                                            ...
                                            <div class="flex flex-col ml-3 items-center">
                                                ...
                                                <p class="text-sm font-medium text-black">Teacher: <?= $subject['teacher_id'] ?></p>
                                            </div>
                                        </li>
                                        <?php $count++; ?>
                                    <?php endforeach; ?>
